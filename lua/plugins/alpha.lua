...
dashboard.section.buttons.val = {
  ...
  button("<C-f>", icons.newFile .. " " .. 'New File', "<cmd>NeoTreeFloat<CR>", {}),
  ...
  button("SPC / y", icons.container .. " " .. "Sync Plugins", "<cmd>PackerSync<CR>", {}),
  button("SPC / u", icons.container .. " " .. "Update Plugins", "<cmd>PackerUpdate<CR>", {}),
