...
keymap("i","<C-s>",   "<Esc><Esc>:w<CR>", silent)
keymap("i","<C-s>",   "<ESC> :w<CR>", silent)
keymap("n","<C-sq>",  ":wq<CR>", silent)
keymap("n","<C-wq>",  ":wq!<CR>", silent)
keymap("n","<S-Q>",   ":q<CR>", silent)
keymap("n","<S-E>",   ":q!<CR>", silent)
keymap("n","0", "^")
keymap("n","Y", "y$")
...
keymap('n', '<C-e>', ":NeoTreeShow<CR>")
keymap('n', '<C-f>', ":NeoTreeFloat<CR>")
keymap('i', '<C-e>', ":NeoTreeShow<CR>")
keymap('i', '<C-f>', ":NeoTreeFloat<CR>")
-- keymap('n', '<leader>x', ":BufferClose<CR>")
keymap("n", "H", "^", silent)

--Hob para buscar palabras en el archvio
keymap('n', 'bd', ":HopChar2<CR>")
keymap('n', 'bu', ":HopChar1<CR>")
keymap('n', '<leader>i', ":HopLineStart<CR>")
